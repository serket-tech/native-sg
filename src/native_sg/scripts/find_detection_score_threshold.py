...
Usage is similar to src/native_sg/evaluate_from_config.py
...
General use: python -m native_sg.scripts.find_detection_score_threshold --config-name="DESIRED_RECIPE" architecture="DESIRED_ARCH"
            checkpoint_params.pretrained_weights="DESIRED_DATASET"

Example: python -m native_sg.scripts.find_detection_score_threshold --config-name=coco2017_yolox architecture=yolox_n
...
from native_sg.common.environment.cfg_utils import add_params_to_cfg
