...
from native_sg import init_trainer, setup_device
...
from native_sg.training.metrics.pose_estimation_utils import compute_oks
from native_sg.training.models.pose_estimation_models.dekr_hrnet import DEKRHorisontalFlipWrapper
...
@hydra.main(
    config_path=pkg_resources.resource_filename("native_sg.recipes", ""), config_name="script_generate_rescoring_data_dekr_coco2017", version_base="1.2"
)
