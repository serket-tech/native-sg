...
from native_sg.training.datasets.data_formats.bbox_formats import BoundingBoxFormat
...
class DetectionOutputAdapter(nn.Module):
    ...
    >>> from native_sg.training.datasets.data_formats.formats import ConcatenatedTensorFormat, BoundingBoxesTensorSliceItem, TensorSliceItem
    >>> from native_sg.training.datasets.data_formats.bbox_formats import XYXYCoordinateFormat, NormalizedXYWHCoordinateFormat
    >>>
