...
from native_sg.training.datasets.data_formats.bbox_formats import convert_bboxes
from native_sg.training.datasets.data_formats.formats import ConcatenatedTensorFormat, apply_on_bboxes, get_permutation_indexes
...
class ConcatenatedTensorFormatConverter:
    def __init__(
        ...
        Example:
            ...
            >>> from native_sg.training.datasets.data_formats.default_formats import LABEL_CXCYWH, LABEL_NORMALIZED_XYXY
            >>> h, w = 100, 200
