from native_sg.common.object_names import ConcatenatedTensorFormats
from native_sg.training.datasets.data_formats.formats import ConcatenatedTensorFormat, BoundingBoxesTensorSliceItem, LabelTensorSliceItem
