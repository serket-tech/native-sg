...
if __name__ == "__main__":
    ds = TrainRescoringDataset("D:/Develop/GitHub/Deci/super-gradients/src/native_sg/rescoring_data.json")
    print(len(ds))
    inputs, targets = next(iter(DataLoader(ds, batch_size=32)))
    print(inputs.size(), targets.size())

    ds = ValTrainRescoringDataset("D:/Develop/GitHub/Deci/super-gradients/src/native_sg/rescoring_data.json")
    print(len(ds))
