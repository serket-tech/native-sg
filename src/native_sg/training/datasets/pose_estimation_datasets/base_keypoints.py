...
from native_sg.common.registry.registry import register_collate_function
from native_sg.module_interfaces import HasPreprocessingParams
from native_sg.training.datasets.pose_estimation_datasets.target_generators import KeypointsTargetsGenerator
from native_sg.training.transforms.keypoint_transforms import KeypointsCompose, KeypointTransform
from native_sg.training.utils.visualization.utils import generate_color_mapping
