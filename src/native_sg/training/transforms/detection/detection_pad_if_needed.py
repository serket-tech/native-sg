...
from native_sg.training.samples import DetectionSample
from native_sg.training.transforms.utils import _pad_image, PaddingCoordinates, _shift_bboxes_xyxy
