...
from native_sg.training.datasets.data_formats.bbox_formats.xywh import xywh_to_xyxy, xyxy_to_xywh
...
class KeypointsRandomRotate90(AbstractKeypointTransform):
    ...
    def apply_to_bboxes(cls, bboxes_xywh: np.ndarray, factor, rows: int, cols: int) -> np.ndarray:
        ...
        """
        from native_sg.training.transforms.transforms import DetectionRandomRotate90
