...
from native_sg.training.losses.dice_loss import DiceLoss, BinaryDiceLoss
from native_sg.training.utils.segmentation_utils import target_to_binary_edge
...
class DiceCEEdgeLoss(_Loss):
    ...
    def component_names(self):
        ...
        See native_sg.Trainer.train() docs for more info.
        """
        names = ["main_loss"]
