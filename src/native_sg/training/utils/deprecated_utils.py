...
def wrap_with_warning(cls: Callable, message: str) -> Any:
    ...
    >>> from native_sg.training.utils.deprecated_utils import wrap_with_warning
    >>> from native_sg.training.utils.callbacks import LinearEpochLRWarmup, LinearBatchLRWarmup
    >>>
    >>> LR_WARMUP_CLS_DICT = {
