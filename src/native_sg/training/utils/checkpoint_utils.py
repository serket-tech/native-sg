...
from native_sg.common.data_interface.adnn_model_repository_data_interface import ADNNModelRepositoryDataInterfaces
from native_sg.common.data_types import StrictLoad
from native_sg.common.decorators.explicit_params_validator import explicit_params_validation
from native_sg.module_interfaces import HasPredict
from native_sg.training.pretrained_models import MODEL_URLS, DATASET_LICENSES
from native_sg.training.utils.distributed_training_utils import wait_for_the_master
from native_sg.common.environment.ddp_utils import get_local_rank
from native_sg.training.utils.utils import unwrap_model
...
def load_checkpoint_to_model(
    ...
    :param strict:                 See native_sg.common.data_types.enum.strict_load.StrictLoad class documentation for details
