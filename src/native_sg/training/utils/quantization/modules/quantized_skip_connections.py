...
from native_sg.modules import Residual, SkipConnection, BackboneInternalSkipConnection, HeadInternalSkipConnection, CrossModelSkipConnection
from native_sg.training.utils.quantization.core import SGQuantMixin
