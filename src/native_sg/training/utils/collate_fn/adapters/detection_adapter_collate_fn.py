...
from native_sg.common.registry import register_collate_function
from native_sg.training.utils.collate_fn import DetectionCollateFN
from native_sg.training.utils.collate_fn.adapters.base_adapter_collate_fn import BaseDatasetAdapterCollateFN
...
class DetectionDatasetAdapterCollateFN(BaseDatasetAdapterCollateFN):
    ...
    def _adapt_samples(self, samples: Iterable[SupportedDataType]) -> List[Tuple[torch.Tensor, torch.Tensor]]:
        ...
        """
        from native_sg.training.utils.detection_utils import xyxy2cxcywh
