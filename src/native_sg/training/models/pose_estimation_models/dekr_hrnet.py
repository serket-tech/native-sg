...
from native_sg.training.utils.predict import ImagesPoseEstimationPrediction
...
from native_sg.training.utils import HpmStruct, DEKRPoseEstimationDecodeCallback, get_param
...
class DEKRPoseEstimationModel(SgModule, HasPredict):
    ...
    def replace_input_channels(self, in_channels: int, compute_new_weights_fn: Optional[Callable[[nn.Module, int], nn.Module]] = None):
        from native_sg.modules.weight_replacement_utils import replace_conv2d_input_channels
