...
from native_sg.common.environment.cfg_utils import load_experiment_cfg
...
from native_sg.training.utils.sg_trainer_utils import parse_args
...
def convert_from_config(cfg: DictConfig) -> str:
    ...
    See:
     native_sg/recipes/conversion_params/default_conversion_params.yaml for the full cfg content documentation,
     and native_sg/examples/convert_recipe_example/convert_recipe_example.py for usage.
    :param cfg:
