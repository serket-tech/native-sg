...
from native_sg.common.data_types.enum.strict_load import StrictLoad
...
from native_sg.common.plugins.deci_client import DeciClient, client_enabled
from native_sg.module_interfaces import HasPredict
from native_sg.training import utils as core_utils
from native_sg.common.exceptions.factory_exceptions import UnknownTypeException
...
from native_sg.training.processing.processing import get_pretrained_processing_params
...
def get(
    ...
    :param strict_load:             See native_sg.common.data_types.enum.strict_load.StrictLoad class documentation for details
