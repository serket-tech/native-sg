...
from native_sg.module_interfaces import SupportsReplaceInputChannels, ExportableSegmentationModel
from native_sg.training.models.classification_models.resnet import BasicResNetBlock, Bottleneck
