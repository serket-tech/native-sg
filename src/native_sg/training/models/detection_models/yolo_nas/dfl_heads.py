...
from native_sg.common.registry import register_detection_module
...
from native_sg.modules.utils import width_multiplier
from native_sg.training.models.detection_models.pp_yolo_e.pp_yolo_head import generate_anchors_for_grid_cell
from native_sg.training.utils import HpmStruct, torch_version_is_greater_or_equal
from native_sg.training.utils.bbox_utils import batch_distance2bbox
from native_sg.training.utils.utils import infer_model_dtype, infer_model_device
