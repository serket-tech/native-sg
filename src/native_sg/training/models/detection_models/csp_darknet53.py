...
from native_sg.common.registry.registry import register_model, register_detection_module
from native_sg.modules import Residual, Conv, BaseDetectionModule
...
from native_sg.common.deprecate import deprecate_param
