...
from native_sg.common.object_names import Processings
from native_sg.common.registry.registry import register_processing
from native_sg.training.datasets.datasets_conf import COCO_DETECTION_CLASSES_LIST, IMAGENET_CLASSES, CITYSCAPES_DEFAULT_SEGMENTATION_CLASSES_LIST
...
from native_sg.training.utils.predict import Prediction, DetectionPrediction, PoseEstimationPrediction, SegmentationPrediction
...
class ReverseImageChannels(Processing):
    ...
    def get_equivalent_photometric_module(self) -> nn.Module:
        from native_sg.conversion.preprocessing_modules import ChannelSelect
...
class StandardizeImage(Processing):
    ...
    def get_equivalent_photometric_module(self) -> nn.Module:
        from native_sg.conversion.preprocessing_modules import ApplyMeanStd
