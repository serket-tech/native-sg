...
from native_sg.training.utils.detection_utils import DetectionPostPredictionCallback, IouThreshold
...
class DetectionMetrics(Metric):
    ...
    def __init__(
        ...
        self.is_distributed = native_sg.is_distributed()
    ...
    def _sync_dist(self, dist_sync_fn=None, process_group=None):
        ...
        if self.world_size is None:
            self.world_size = native_sg.common.environment.ddp_utils.get_world_size() if self.is_distributed else -1
