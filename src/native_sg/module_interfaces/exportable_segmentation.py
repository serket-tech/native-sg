...
from native_sg.conversion import ExportTargetBackend, ExportQuantizationMode
...
from native_sg.training.utils.export_utils import (
...
class ExportableSegmentationModel:
    ...
    def export(
        ...
        usage_instructions.append("    from native_sg.training.utils.visualization.segmentation import overlay_segmentation")
