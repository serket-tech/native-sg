...
from native_sg.module_interfaces.usage_instructions import build_usage_instructions_for_pose_estimation
...
class ExportablePoseEstimationModel:
    ...
    def export(
        ...
        from native_sg.conversion.onnx.pose_nms import attach_onnx_pose_nms
