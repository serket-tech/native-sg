...
from native_sg.conversion import ExportTargetBackend, ExportQuantizationMode, DetectionOutputFormatMode
from native_sg.conversion.conversion_utils import find_compatible_model_device_for_dtype
...
from native_sg.module_interfaces.exceptions import ModelHasNoPreprocessingParamsException
from native_sg.module_interfaces.supports_input_shape_check import SupportsInputShapeCheck
from native_sg.training.utils.export_utils import infer_format_from_file_name, infer_image_shape_from_model, infer_image_input_channels
from native_sg.training.utils.utils import infer_model_device, check_model_contains_quantized_modules, infer_model_dtype
...
class ExportableObjectDetectionModel:
    ...
    def export(
        ...
        from native_sg.conversion.conversion_utils import torch_dtype_to_numpy_dtype
        from native_sg.conversion.onnx.nms import attach_onnx_nms
        from native_sg.conversion.preprocessing_modules import CastTensorTo
        from native_sg.conversion.tensorrt.nms import attach_tensorrt_nms
        ...
        if quantization_mode == ExportQuantizationMode.INT8:
            from native_sg.training.utils.quantization import ptq
        ...
        from native_sg.training.models.conversion import ConvertableCompletePipelineModel
