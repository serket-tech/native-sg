...
General use: python -m native_sg.convert_recipe_to_code DESIRED_RECIPE OUTPUT_SCRIPT
Example:     python -m native_sg.convert_recipe_to_code coco2017_yolo_nas_s train_coco2017_yolo_nas_s.py
...
from native_sg.common.environment.omegaconf_utils import register_hydra_resolvers
...
from native_sg.common.data_types.enum import MultiGPUMode, StrictLoad
"""
...
def main() -> None:
    ...
    parser.add_argument("--config_dir", type=str, default=pkg_resources.resource_filename("native_sg.recipes", ""), help="The config directory path")
