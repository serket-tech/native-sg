...
# fmt: off
from native_sg.examples.train_from_recipe_with_user_objects.user_dataset import user_mnist_train, user_mnist_val  # noqa: F401

# fmt: on


@hydra.main(config_path=pkg_resources.resource_filename("native_sg.recipes", ""), config_name="user_recipe_mnist_example", version_base="1.2")
