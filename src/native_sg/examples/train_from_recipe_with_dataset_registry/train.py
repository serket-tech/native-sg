...
# fmt: off
from native_sg.examples.train_from_recipe_with_dataset_registry.user_dataset import MnistDataset  # noqa: F401

# fmt: on


@hydra.main(
    config_path=pkg_resources.resource_filename("native_sg.recipes", ""),
