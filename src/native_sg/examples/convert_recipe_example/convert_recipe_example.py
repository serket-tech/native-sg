...
For more optoins see : native_sg/recipes/conversion_params/default_conversion_params.yaml.

Note: conversion_params yaml file should reside under native_sg/recipes/conversion_params
"""
...
@hydra.main(config_path=pkg_resources.resource_filename("native_sg.recipes.conversion_params", ""), version_base="1.2")
