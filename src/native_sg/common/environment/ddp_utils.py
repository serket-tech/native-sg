...
from native_sg.common.environment.argparse_utils import pop_local_rank


def init_trainer():
    """
    Initialize the native_sg environment.

    This function should be the first thing to be called by any code running native_sg.
    """
