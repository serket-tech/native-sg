...
from native_sg.common.plugins.wandb.log_predictions import visualize_image_detection_prediction_on_wandb
from native_sg.training.models.predictions import DetectionPrediction
from native_sg.training.utils.predict import ImageDetectionPrediction
