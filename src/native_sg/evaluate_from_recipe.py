...
General use: python -m native_sg.evaluate_from_recipe --config-name="DESIRED_RECIPE".
...
python -m native_sg.evaluate_from_recipe --config-name="DESIRED_RECIPE" training_hyperparams.ckpt_name=average_model.pth
